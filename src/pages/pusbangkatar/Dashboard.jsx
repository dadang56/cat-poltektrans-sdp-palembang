...
import {
    Users, ClipboardCheck, Award, TrendingUp, ChevronRight, BarChart3
} from 'lucide-react'
        ...
        const loadStats = async () => {
            try {
                if (isSupabaseConfigured()) {
                    ...
                    const withNK = mahasiswa.filter(m => m.nilai_kondite !== null && m.nilai_kondite !== undefined)
                    const withNS = mahasiswa.filter(m => m.nilai_semapta !== null && m.nilai_semapta !== undefined)
            ...
            <div className="pb-dashboard animate-fadeIn">
                ...
                <div className="pb-overview-card">
                    <div className="pb-overview-header">
                        <BarChart3 size={20} />
                        <h3>Progress Penilaian Keseluruhan</h3>
                    </div>

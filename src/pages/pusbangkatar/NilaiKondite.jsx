...
function NilaiKondite() {
    ...
    const getCurrentNilai = (mahasiswa) => {
        ...
        return mahasiswa.nilai_kondite !== null ? mahasiswa.nilai_kondite : ''
    }
        ...
        <DashboardLayout>
            <div className="nilai-page animate-fadeIn">
                <div className="page-header">
                    <div>
                        <h1 className="page-title">Nilai Kondite</h1>
                        <p className="page-subtitle">Input nilai kondite mahasiswa (skala 0-4)</p>
                    </div>
                    <button
                        ...
                        <table className="data-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Prodi</th>
                                    <th>Kelas</th>
                                    <th style={{ width: '120px' }}>Nilai Kondite</th>
                                </tr>
                            </thead>
                            <tbody>
                                {loading ? (
